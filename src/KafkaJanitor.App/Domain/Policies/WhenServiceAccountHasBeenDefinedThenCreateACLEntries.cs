...
public class WhenServiceAccountHasBeenDefinedThenCreateACLEntries : IMessageHandler<ServiceAccountHasBeenDefined>
{
    private readonly ILogger<WhenServiceAccountHasBeenDefinedThenCreateACLEntries> _logger;
    private readonly ITopicProvisioningApplicationService _applicationService;

    public WhenServiceAccountHasBeenDefinedThenCreateACLEntries(ILogger<WhenServiceAccountHasBeenDefinedThenCreateACLEntries> logger,
    ...
    public async Task Handle(ServiceAccountHasBeenDefined message, MessageHandlerContext context)
    {
        ...
        await _applicationService.CreateMissingACLEntry(serviceAccountId);
    }
}